...
export default function UploadPage() {
  ...
  const handleSubmit = async (force = false) => {
    ...
    // Auto-run check for Will type before upload (unless forcing)
  ...
  const needsForce =
    checkResult && checkResult.score < 100 && isWillType && !result;
    ...
    <AppShell>
      <div className="max-w-4xl">
        ...
        <p className="text-sm text-gray-600 mb-8">
          ...
          Wills are automatically checked for completeness before registration.
        </p>
